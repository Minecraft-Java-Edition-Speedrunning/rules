...
- A.10.3.a) <A.10.3.a> Clarification: Rebinding these in the game to abuse repeated inputs is allowed in glitched, see #entangledRule("D.1.2.ag").
...
- D.1.2.ag) <D.1.2.ag> Rebinding the "Attack/Destroy" or "Use Item/Place Block" functions to a keyboard button inside Minecraft to abuse repeated inputs.
- #entangled[Entangled Rule(s):]
- #entangled[D.1.2.ag is referenced by: ] #entangledRule("A.10.3.a")
