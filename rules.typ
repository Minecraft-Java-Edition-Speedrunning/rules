...
CE17.1.1) The run is considered complete once a region of space that has a width and depth of 16 blocks and a height spanning the space between the highest level of the bedrock floor to world height if in the Overworld or the lowest level of the bedrock ceiling if in the Nether is filled only by air blocks.
